...
Deployable server template for auth.provider. This is the composition root — it reads config, loads modules, and starts the Express server. Generated by `create-o3co-auth-provider`.
...
- [`create-o3co-auth-provider`](../../create-app) — CLI scaffolder that generates this template
