...
| `mtls_revocation_unavailable_allowed` (warn), **any**, if you chose `allow` | same | each line is a certificate that was not revocation-checked on a request that was served; a steady rate means the PKI is effectively unrevocable |
