...
var EOF_TOKEN = { kind: "eof", value: "", line: 0, col: 0, isQuoted: false, precedingSpace: false, subst: void 0 };
var Parser = class {
  constructor(tokens) {
    this.tokens = tokens;
    this.pos = 0;
