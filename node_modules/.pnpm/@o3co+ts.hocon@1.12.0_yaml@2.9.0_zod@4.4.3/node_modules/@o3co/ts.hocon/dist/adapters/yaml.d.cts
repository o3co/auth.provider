 ...
 */
declare function parseYaml(input: string, originDescription?: string): Config;
/**
 ...
 */
declare function fromYamlValue(value: unknown, originDescription?: string): Config;

export { fromYamlValue, parseYaml };
