 ...
 */
declare function loadEnv(opts?: EnvOptions & {
 ...
 */
declare function parseDotEnv(input: string, opts?: EnvOptions): Config;

export { type EnvOptions, loadEnv, parseDotEnv };
