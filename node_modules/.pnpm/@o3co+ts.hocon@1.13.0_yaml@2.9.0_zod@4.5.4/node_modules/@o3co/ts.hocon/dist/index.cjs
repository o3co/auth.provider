...
__export(src_exports, {
  ...
  parseFileWithOptions: () => parseFileWithOptions,
  parseString: () => parseString,
  parseStringWithOptions: () => parseStringWithOptions
});
...
var Parser = class {
  ...
  parse() {
    ...
    if (t.kind === "lbrace") {
      ...
      this.skip("newline");
      const remaining2 = this.peek();
      if (remaining2.kind !== "eof") {
        throw new ParseError(`Unexpected token '${remaining2.value}' after closing brace`, remaining2.line, remaining2.col);
      }
    ...
    if (t.kind === "lbracket") {
      ...
      const remaining2 = this.peek();
      if (remaining2.kind !== "eof") {
        throw new ParseError(`Unexpected token '${remaining2.value}' after root array`, remaining2.line, remaining2.col);
      }
...
function pickRequire(candidate, metaUrl) {
  ...
  return (0, import_node_module.createRequire)(metaUrl ?? (0, import_node_url.pathToFileURL)(nodePath.join(process.cwd(), "noop.js")));
}
