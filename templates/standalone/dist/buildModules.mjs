 ...
 */
import { defaultRefreshTokenFamilyRevocationModule, defaultRefreshTokenFamilyRotationModule, memoryRefreshTokenFamilyStoreModule, } from "@o3co/auth-provider-core";
...
import { googleFederationConfigModule, keyStoreModule, repositoriesModule, storesModule, } from "./modules.mjs";
/**
 ...
 * provider.
 */
export function buildModules(config, overrides = {}) {
    const googleEnabled = config.federations?.google?.enabled === true;
    return [
        oauthModule({ config }),
