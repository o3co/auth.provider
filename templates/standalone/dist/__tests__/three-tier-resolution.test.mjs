...
function buildResolvedConfig(env, extraEnv = {}) {
    ...
    return validate(parseFile(envConfPath, { env: resolvedEnv })
        ...
        .withFallback(parseFile(libraryReferencePath, { env: resolvedEnv })), AppConfigSchema);
}
const grants = (config) => config.oauth.grants ?? {};
