 ...
 */
export declare const SESSION_STORE_UNAVAILABLE: Readonly<{
 ...
 */
export declare const USER_DIRECTORY_UNAVAILABLE: Readonly<{
    error: "temporarily_unavailable";
 ...
 * was sent.
 */
export declare function guardCookieSession(middleware: RequestHandler, logger: Pick<Logger, "error">): RequestHandler;
/**
 ...
 */
export declare function abandonCookieSession(req: Request): void;
