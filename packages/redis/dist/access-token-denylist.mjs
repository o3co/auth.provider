 ...
 * adapter's `Map.set`.
 */
export function createRedisAccessTokenDenylist(opts) {
    const { client, keyPrefix } = opts;
    const fullKey = (jti) => `${keyPrefix}${jti}`;
    return {
        kind: "redis",
 ...
 */
export const redisAccessTokenDenylistBuilder = (config, _ctx) => {
    const c = config;
...
export const redisAccessTokenDenylistModule = defineModule({
    ...
    requires: ["accessTokenDenylistClient", "config"],
