...
export function createRedisDeviceCodeStore(opts) {
 ...
 */
export const redisDeviceCodeStoreBuilder = (config, _ctx) => {
    const c = config;
...
export const redisDeviceCodeStoreModule = defineModule({
    ...
    requires: ["deviceCodeStoreClient", "config"],
