        ...
        async endSession(req) {
            ...
            if (config.endSessionEndpoint) {
                ...
                try {
                    ...
                    throw new Error(`Google federation "google" has an invalid endSessionEndpoint: ${config.endSessionEndpoint}`);
                }
                if (req.idTokenHint)
            ...
            try {
                ...
                throw new Error(`Google federation "google" received an invalid postLogoutRedirectUri: ${base}`);
            }
            if (req.state)
                url.searchParams.set("state", req.state);
            return { url, method: "GET" };
...
export const googleFederationModule = defineModule({
    ...
    requires: ["googleFederationConfig"],
    contributes: {
        federations: {
