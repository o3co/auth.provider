 ...
 */
export const resolveFullPkiTuning = (partial) => ({
    maxChainDepth: typeof partial?.["max-chain-depth"] === "number"
        ? partial["max-chain-depth"]
        : FULL_PKI_DEFAULTS.maxChainDepth,
    signatureAlgorithms: Array.isArray(partial?.["signature-algorithms"]) && partial["signature-algorithms"].length > 0
        ? partial["signature-algorithms"]
        : FULL_PKI_DEFAULTS.signatureAlgorithms,
    minRsaKeyBits: typeof partial?.["min-rsa-key-bits"] === "number"
