...
import {
	...
	type VerificationUnavailableReason,
...
export function refuseVerificationUnavailable(
	res: Response,
	err: JwtVerificationError & { readonly reason: VerificationUnavailableReason },
	logger: Pick<Logger, "error"> | undefined,
	site: VerificationSite,
): Response {
	logger?.error(
		{ site, reason: err.reason, err: loggableError(err) },
