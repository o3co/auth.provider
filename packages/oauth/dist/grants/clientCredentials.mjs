 ...
 */
export const createClientCredentialsGrant = (deps) => {
    ...
    return {
        async handle(ctx) {
            ...
            if (deps.grantPolicy && resourceIndicatorEnabled) {
                ...
                // ceiling.
                const resource = extractResourceParam(ctx.body);
                let decision;
                try {
