...
const ABANDONED = new Set(["AbortError", "TimeoutError"]);
 ...
 */
const X509_VERIFICATION = new Set([
 ...
 */
const isTransportCode = (code) => typeof code === "string" &&
    (CONNECTION.has(code) ||
...
const serverError = (status) => typeof status === "number" && Number.isInteger(status) && status >= 500 && status <= 599;
/**
