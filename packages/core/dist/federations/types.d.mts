...
export declare function supportsLogout(provider: FederationProvider | undefined | null): provider is FederationProvider & SupportsLogout;
...
export declare function supportsClaimMapping(p: FederationProvider | undefined | null): p is FederationProvider & SupportsClaimMapping;
/**
...
export declare function supportsRefresh(p: FederationProvider | undefined | null): p is FederationProvider & SupportsRefresh;
/**
 ...
 */
export declare const RESERVED_DELEGATED_AUTHORIZATION_PARAMS: ReadonlySet<string>;
/**
 ...
 */
export declare const RESERVED_IDENTITY_CLAIMS: ReadonlySet<string>;
/**
 ...
 */
export declare function identityClaimsProblem(names: readonly unknown[]): string | undefined;
/**
 ...
 */
export declare function selectIdentityClaims(claims: Readonly<Record<string, unknown>>, names: readonly string[]): Readonly<Record<string, string>>;
/**
...
export declare function supportsDelegatedAuthorization(p: FederationProvider | undefined | null): p is FederationProvider & SupportsDelegatedAuthorization;
