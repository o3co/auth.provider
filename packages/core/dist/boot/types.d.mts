...
import type { AuditHook, ExchangeTokenValidator, FederationProvider, GrantHandler, GrantPolicyHook, MfaFactor } from "../modules/manifest/contributes-map.mjs";
 ...
 * Per A2-β §3.2 + A5 §6.
 */
export type ContributionKind = "grants" | "federations" | "federationRedirectPolicies" | "tokenExchangeValidators" | "mfaFactors" | "auditHooks" | "routes" | "grantPolicyHooks" | (string & {
    readonly __consumerKind?: unique symbol;
});
/**
 ...
 * Per A2-β §6.1.
 */
export type BootStage = "validateManifests" | "planBoot" | "materializeComponents" | "applyContributions" | "freezeWorld" | "assembleApp";
/**
 ...
 */
export type BootErrorReason = "duplicate-module-name" | "duplicate-provides" | "bootstrap-component-collision" | "synthetic-key-collision" | "missing-required-component" | "unknown-contribution-kind" | "duplicate-contribute" | "override-target-missing" | "duplicate-override" | "contribute-and-override-same-key" | "list-shaped-override-not-allowed" | "lifecycle-without-provides" | "invalid-route-advertisement-path" | "config-validation-failed" | "circular-dependency" | "provides-factory-failed" | "contribute-factory-failed" | "route-order-cycle" | "route-order-target-missing" | "federation-redirect-policy-unpaired" | "grant-policy-without-issuer" | "mfa-partial-wiring" | "federation-stores-incomplete";
/** Per A2-β §6.1. */
 ...
 */
export type BootErrorDetails = DuplicateModuleNameDetails | DuplicateProvidesDetails | BootstrapComponentCollisionDetails | SyntheticKeyCollisionDetails | MissingRequiredComponentDetails | UnknownContributionKindDetails | DuplicateContributeDetails | OverrideTargetMissingDetails | DuplicateOverrideDetails | ContributeAndOverrideSameKeyDetails | ListShapedOverrideDetails | LifecycleWithoutProvidesDetails | InvalidRouteAdvertisementPathDetails | ConfigValidationFailedDetails | CircularDependencyDetails | ProvidesFactoryFailedDetails | ContributeFactoryFailedDetails | RouteOrderCycleDetails | RouteOrderTargetMissingDetails | FederationRedirectPolicyUnpairedDetails | GrantPolicyWithoutIssuerDetails | MfaPartialWiringDetails | FederationStoresIncompleteDetails;
/**
