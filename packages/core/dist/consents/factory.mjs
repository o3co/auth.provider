 ...
 */
export function createConsentStoreFactory() {
    return createAdapterFactory("ConsentStore");
}
/**
 ...
 */
export function registerBuiltinConsentStores(factory) {
    factory.register("memory", () => createMemoryConsentStore());
}
/** Create an empty PendingConsentStoreFactory. */
export function createPendingConsentStoreFactory() {
    return createAdapterFactory("PendingConsentStore");
}
/**
 ...
 */
export function registerBuiltinPendingConsentStores(factory) {
