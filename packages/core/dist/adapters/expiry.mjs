 ...
 */
export const isStorableExpiry = (expiresAtMs) => Number.isFinite(expiresAtMs) && Math.abs(Math.ceil(expiresAtMs)) <= MAX_STORABLE_EXPIRY_MS;
/**
 ...
 * not negative.
 */
export const isStorableLifetime = (lifetimeMs, options = {}) => Number.isFinite(lifetimeMs) &&
