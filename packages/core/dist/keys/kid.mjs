 ...
 */
export const isWellFormedKid = (kid) => isWellFormedIdentifier(kid);
/**
 ...
 */
export function assertWellFormedKids(owner, kids) {
    for (const [where, kid] of kids) {
        if (!isWellFormedKid(kid)) {
            throw new Error(`${owner}: ${where} is not a usable key id (${describeMalformedIdentifier(kid)}). ` +
