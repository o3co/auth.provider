import type { GrantPolicyContext, GrantPolicyDecision, GrantPolicyHook, GrantPolicyRequest } from "../policy/types.mjs";
 ...
 */
export declare function policyOutOfBounds(errorDescription: string): GrantError;
/**
 ...
 */
export declare function evaluateGrantPolicy(grantPolicy: GrantPolicyHook, request: GrantPolicyRequest, context: GrantPolicyContext, effectiveScopes: readonly string[], scopeCeiling?: PolicyScopeCeiling): Promise<GrantPolicyOutcome>;
 ...
 */
export declare function boundPolicyAudience(decision: GrantPolicyAllow, ceiling: readonly string[] | undefined): PolicyAudienceOutcome;
//# sourceMappingURL=grantPolicy.d.mts.map