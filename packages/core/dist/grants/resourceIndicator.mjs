 ...
 * an array of strings.
 */
export function readTargetParameter(value) {
 ...
 */
export function extractResourceParam(body) {
 ...
 */
export function deriveAudienceFromResources(resources, allow) {
 ...
 */
export function unrepresentedResources(resources, audience) {
    if (!resources || resources.length === 0)
        return [];
