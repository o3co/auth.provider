 ...
 * an array of strings.
 */
export declare function readTargetParameter(value: unknown): readonly string[] | null;
/**
 ...
 */
export declare function deriveAudienceFromResources(resources: readonly string[] | null | undefined, allow: ReadonlySet<string>): string | undefined;
/**
 ...
 */
export declare function unrepresentedResources(resources: readonly string[] | null | undefined, audience: string | null | undefined): readonly string[];
//# sourceMappingURL=resourceIndicator.d.mts.map