...
export type FederationGrantRevokedBy = "client" | "subject" | "operator" | "logout_policy" | "backstop";
...
export interface FederationGrantRevocation {
    ...
    readonly revocation: {
        readonly by: FederationGrantRevokedBy;
        readonly at: Date;
    };
}
/**
...
export type PendingFederationGrant = FederationGrantBase & NeverAuthorized & {
    readonly status: "pending";
};
export type AuthorizedFederationGrant = FederationGrantBase & FederationGrantAuthorization & FederationGrantUsage & {
 ...
 */
export type RevokedFederationGrant = (FederationGrantBase & FederationGrantAuthorization & FederationGrantUsage & FederationGrantRevocation) | (FederationGrantBase & NeverAuthorized & FederationGrantRevocation);
/** The stored record. `expired` is not a stored status: it is read off the clock (D1, D3). */
export type FederationGrant = PendingFederationGrant | AuthorizedFederationGrant | RevokedFederationGrant;
/** Narrows a revoked grant to the one that was authorized before it was revoked. */
export declare function hasFederationGrantAuthorization<G extends FederationGrant>(grant: G): grant is G & FederationGrantAuthorization;
/**
...
export type FederationGrantIneligibilityReason = "no_finite_lifetime" | "lifetime_over_maximum" | "scope_exceeded"
...
export type FederationGrantReauthorizationReason = "upstream_invalid_grant" | "connection_changed" | "credential_unreadable" | "upstream_interaction_required" | "upstream_login_required" | "upstream_consent_required" | "upstream_account_selection_required";
...
export type EffectiveFederationGrantStatus = {
    ...
    readonly reason: FederationGrantExpiredReason;
} | {
    readonly status: "revoked";
    readonly reason: FederationGrantRevokedBy;
}
...
export type FederationGrantUnavailableReason = "upstream" | "storage" | "lock_timeout"
/**
 ...
 */
 | "concurrent_update" | "key_unavailable";
/**
...
export type FederationGrantDenial = {
    ...
    readonly code: "grant_expired";
    readonly reason: FederationGrantExpiredReason;
} | {
    readonly code: "grant_revoked";
    readonly reason: FederationGrantRevokedBy;
} | {
    ...
    readonly reason: "connection_not_permitted";
} | {
