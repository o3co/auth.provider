import type { FederationGrant, FederationGrantAuthorization, FederationGrantCredentials, FederationGrantIneligibilityMarker, FederationGrantRefreshFailureInput, FederationGrantRevokedBy } from "./types.mjs";
/**
...
export interface FederationGrantStore {
     ...
     */
    acquireRefreshLock(grantId: string, options: {
...
export interface FederationGrantOpened {
    ...
    readonly credentials: {
        readonly state: "ok";
        readonly value: FederationGrantCredentials;
    } | {
