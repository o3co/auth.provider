 ...
 */
export declare const FEDERATION_GRANT_FLOW_BUDGET_MS = 600000;
/**
 ...
 * suite checks it.
 */
export declare const FEDERATION_GRANT_FIRST_INTENTS_PER_CLIENT_SUBJECT_LIMIT = 16;
/**
...
export type FederationGrantConsentAnswerResult = {
    ...
    readonly transaction: FederationGrantConnectTransaction;
} | {
    readonly outcome: "refused";
    readonly reason: "state_collision";
};
/**
...
export type FederationGrantIntentWrite = {
    ...
    readonly outcome: "refused";
    readonly reason: FederationGrantIntentRefusal;
};
 ...
 */
export declare function federationGrantConsentExpiry(consentAt: Date, lifetimeMs: number): Date;
...
//# sourceMappingURL=intentStore.d.mts.map