 ...
 */
export const resolveDeviceVerificationLimitSpec = (limits, config) => {
    const result = { ...limits };
    if (result[DEVICE_VERIFICATION_RATE_LIMIT_PREFIX] !== undefined)
        return result;
    const spec = config?.oauth?.deviceAuthorization?.rateLimit;
