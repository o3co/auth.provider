		...
		.object({
			...
			storage: z
				.object({
					...
					// default): sessionStoreModule spreads `storage[storage.type]`
					// into the store factory — see packages/session/src/modules/
					// sessionStoreModule.mts (storageSlice[storageSlice.type]).
					redis: z
						.object({
							url: z.string(),
