...
import type { ComponentLifecycle } from "../module-spec.mjs";
import type { ModuleSpec } from "../module-spec.mjs";
...
it("ModuleSpec.lifecycle accepts an eager + cleanup map keyed by ComponentKey", () => {
  ...
  expectTypeOf<SlotEntry>().toEqualTypeOf<
    ComponentLifecycle<"testLifecycleSlot"> | undefined
  >();
});
