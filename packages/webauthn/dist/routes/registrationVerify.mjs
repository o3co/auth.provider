 ...
 */
export function createRegistrationVerifyHandler(deps) {
    return async (req, res) => {
        ...
        if (userIdByteLength < 1 || userIdByteLength > 64) {
            res.status(500).json({
                error: "server_error",
                error_description: "webauthnSubject.userId must be 1-64 bytes per WebAuthn §5.4.3 (opaque user-handle)",
            });
            return;
        }
        ...
        const clientDataJSONBase64 = innerResponse !== null &&
            typeof innerResponse === "object" &&
            "clientDataJSON" in innerResponse
            ? innerResponse.clientDataJSON
            : undefined;
