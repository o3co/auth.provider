...
export declare function createFederationGrantLog(given: Logger | undefined): FederationGrantLog;
/**
 ...
 */
export declare const readField: (error: unknown, key: string) => unknown;
/** `error instanceof type`, or `false` when asking throws (a Proxy whose prototype cannot be read). */
export declare const isInstance: (error: unknown, type: abstract new (...args: never[]) => unknown) => boolean;
export {};
