...
export function allowedConnectionsOf(req) {
    return federationGrantAllowlist(req.oauthClient?.allowedFederationGrantConnections);
}
export const allows = (req, connection) => allowedConnectionsOf(req).includes(connection);
