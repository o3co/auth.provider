 ...
 */
import { federationGrantAuditMetadata, } from "@o3co/auth-provider-core";
...
const NOT_FOUND = { error: "grant_not_found" };
export function createFederationGrantRevokeHandler(options) {
    ...
    return async (req, res) => {
         ...
         */
        const deny = (status, body, outcome, subject) => {
        ...
        if (release === undefined) {
            deny(503, { error: "service_unavailable", error_description: "shutting_down" }, "service_unavailable/shutting_down");
            return;
        }
        try {
            ...
            if (client === undefined) {
                ...
                deny(500, { error: "server_error", error_description: "unexpected_error" }, "server_error/unexpected_error", subject);
                return;
            }
            let grant;
            try {
                ...
                deny(503, { error: "temporarily_unavailable", error_description: "storage" }, "temporarily_unavailable/storage", subject);
                return;
            }
            ...
            deny(500, { error: "server_error", error_description: "unexpected_error" }, "server_error/unexpected_error");
        }
        finally {
            release();
        }
