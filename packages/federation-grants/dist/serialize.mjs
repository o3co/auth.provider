...
export function serializeFederationGrantTokenResult(result) {
    if (result.ok) {
        return {
            status: 200,
            body: {
...
export function serializeFederationGrantLodgingRefusal(result) {
    const answer = (status, error, description) => ({
        status,
