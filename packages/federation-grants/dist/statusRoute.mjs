 ...
 */
import { effectiveFederationGrantStatus, federationGrantAuditMetadata, } from "@o3co/auth-provider-core";
...
export function createFederationGrantStatusHandler(options) {
    ...
    return async (req, res) => {
        ...
        try {
            ...
            const permitted = () => allows(req, grant.connection);
            const refusePermission = () => {
                res
                    .status(403)
            ...
            if (grant.status === "revoked") {
                ...
                res
                    .status(200)
                    .json(federationGrantStatusView(grant, { status: "revoked", reason: grant.revocation.by }, maxExpiresInMs, permitted()));
                return;
            }
            ...
            if (inspection.credentials === "key_unavailable" &&
